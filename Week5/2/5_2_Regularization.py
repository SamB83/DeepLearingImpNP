...
def forward_propagation_with_dropout(X, parameters, keep_prob = 0.5):
    ...
    A1 = (1/keep_prob)*A1                             # Step 4: scale the value of neurons that haven't been shut down
    ### END CODE HERE ###
    Z2 = np.dot(W2, A1) + b2
    A2 = relu(Z2)
    ...
    A2 = (1/keep_prob)*A2                             # Step 4: scale the value of neurons that haven't been shut down
    ### END CODE HERE ###
    Z3 = np.dot(W3, A2) + b3
    A3 = sigmoid(Z3)
...
def backward_propagation_with_dropout(X, Y, cache, keep_prob):
    ...
    dA2 = (1/keep_prob)*dA2   # Step 2: Scale the value of neurons that haven't been shut down
    ### END CODE HERE ###
    dZ2 = np.multiply(dA2, np.int64(A2 > 0))
