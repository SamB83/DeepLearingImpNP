...
print("With sigmoid: linear_activation_cache = " + str(linear_activation_cache))

A, linear_activation_cache = linear_activation_forward(A_prev, W, b, activation = "relu")
print("With ReLU: A = " + str(A))
print("With ReLU: linear_activation_cache = " + str(linear_activation_cache))
...
def L_model_backward(AL, Y, caches):
    ...
    for l in reversed(range(L-1)):#range here is L-2,L-3,.....,0
